    ...
    var body: some View {
        NavigationView {
            List {
                ...
                NavigationLink(destination:
                                FavoritesPrimesView(state: self.state)) {
...
class AppState: ObservableObject {
    ...
    @Published var loggedIntUSer : User? = nil
